            ...
            <div>
                <form>
                    <div className="regist_input_wrap">
                        ...
                        <input type="text" className="regist_input" name="gr_name" value={grName} onChange={grNameChangeHandler}/> <br/><br/>
                        <span className="regist_text">희망 가격 </span>
                        <input type="number" className="regist_input" name="gr_price" value={grPrice} onChange={grPriceChangeHandler}/> <br/><br/>
                        <span className="regist_text">간단한 설명 </span>
                        <input type="text" className="regist_input" name="gr_info" value={grInfo} onChange={grInfoChangeHandler}/> <br/><br/>
                    </div>
                    <label
                        ...
                        {img.length !== 0 ? (
                            img.map((image, index) => (
                                <div key={index} className="img_angle">                                    
                                    <img className="add_img" src={image} alt="uploaded" /><br/>
                                    <button className="delete_btn" onClick={(e) => deleteBtnHandler(index, e)}><img src="/img/delete_FILL0_wght400_GRAD0_opsz24.png" alt="delete" /></button>      
                                </div>
                            ))
                        ) : (
                    ...
                    <div className="regist_btn_wrap">
                        <input className="regist_btn" type="button" value={isModify ? "Auction Modify" : "Auction Regist"} 
