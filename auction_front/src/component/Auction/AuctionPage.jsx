            ...
            <div className="auction_page_wrap">
                <div className="auction_semi_info">
                    <div className="auction_back_img">
                        ...
                        <button>
                            <img src="/img/arrow_right.png" onClick={rightBtnClickHandler} />
                        </button>
                    </div>
                ...
                <div className="auction_area">
                    ...
                    <div className="auction_progress">
                        ...
                        <div className="auction_btn">
                            <button onClick={normalBidBtnHandler} disabled={isAuctionEnd}>
                            ...
                            <div className="call_bid">
                                ...
                                <div>
                                    <button onClick={asBidBtnHandler} disabled={isAuctionEnd}>
                                        호가 입찰
                                    </button>
                                </div>
                            </div>
