                ...
                <div className="first_sec">
                    <div className="intro_company_sec">
                        ...
                        <div className="definition_txt">
                            <div>수집품의 가치를 높이는 흥미로운 경매, 비드버드에서 새로운 수집 경험을 시작하세요!</div>
                            <div>
                                비드버드는 수집의 즐거움을 넘어서 수집품의 가치를 올리는 경매의 흥미진진한 경험을
                                제공합니다. 다양한 분야의 수집품들이 모여 있어, 아트, 안티크, 고급 장난감부터 특별한
                                컬렉션 아이템까지 다양한 선택의 기회를 제공합니다. 또한, 수집가와 판매자 사이의 원활한
                                거래를 도와주는 전문적인 시스템과 서비스를 통해 안전하고 신뢰성 있는 거래 환경을
                                제공합니다. 비드버드는 수집의 즐거움과 경매의 흥미를 한데 모아, 수집가들에게 새로운
                                경험과 가치를 제공하는 플랫폼입니다.
                            </div>
                        </div>
