...
function CertificationAPI() {
    ...
    useEffect(() => {
        IMP.init('imp55455045'); //세션 나갔는지 확인해야됨
    ...
    // =====================================================================================
    /*
    async function axios_certificationDB(rsp) {
        console.log('[CertificationAPI.jsx] axios_certificationDB');
        console.log('rsp.imp_uid===>>>>>', rsp.imp_uid);
        try {
            await axios.post(`${SERVER_URL.SERVER_URL()}/point/certifications`, {
    ...
    */
    ...
    async function axios_certificationDB(imp_uid) {
        ...
        try {
            ...
            console.log('[CertificationAPI.jsx] 11111111111');
