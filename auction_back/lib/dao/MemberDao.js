...
const MemberDao = {
    ...
    cancelGoods: (req) => {
        return new Promise((resolve, reject) => {
            ...
            DB.query('DELETE FROM TBL_GOODS_IMG WHERE GR_NO = ?', [gr_no], (err, rst) => {
                if (err) {
                    console.log(err);
                    resolve('error');
                    return;
    ...
    getMySells: (req) => {
        return new Promise((resolve, reject) => {
            ...
            DB.query(
                `SELECT AR.AR_IS_BID, AR.AR_POINT, AR.AR_REG_DATE, GR.GR_NAME, GR.GR_PRICE, GR.GR_INFO
    ...
    modifyGoodsSelect: (req) => {
        return new Promise((resolve, reject) => {
            ...
            DB.query(`SELECT * FROM TBL_GOODS_REGIST WHERE GR_NO = ?`, [gr_no], (err, goods) => {
                if (err) {
                    console.log(err);
                    reject(err);
                    return;
